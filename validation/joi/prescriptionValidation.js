...
let prescriptionSubItemTemplate = {
...
let prescriptionSubItemCreationJoiSchema = Joi.object().keys({
    ...prescriptionSubItemTemplate
})

let prescriptionSubItemEditJoiSchema = Joi.object().keys({
    ...prescriptionSubItemTemplate, _id: Joi.string().hex().length(24)
})
...
const createPrescriptionSchema = Joi.object({
    ...
    medicineList: Joi.array().items(prescriptionSubItemCreationJoiSchema),
...
const editPrescriptionSchema = Joi.object({
    ...
    medicineList: Joi.array().items(prescriptionSubItemEditJoiSchema),
